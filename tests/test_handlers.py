...
class HttpRequestHandlerTestCase(TestCase):
    ...
    def test_valid_response(self):
        ...
        h._send_request = Mock(return_value=(headers, body))
        self.assertEqual(self.test_data, h.process_request('uber.method_list'))
    ...
    def test_updating_token_exeption_after_three_tries(self):
        returns = [
            self.token_response,
            self.token_response,
            self.token_response,
